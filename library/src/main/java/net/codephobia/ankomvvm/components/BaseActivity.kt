...
abstract class BaseActivity<T : BaseNavigator, V : BaseViewModel<T>> : BaseNavigator, AppCompatActivity(), AnkoLogger {
    ...
    override fun showToast(messageRes: Int) = toast(messageRes)
